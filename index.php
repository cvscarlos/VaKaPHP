<?php
// Constants required
// Constantes obrigatуrias
defined("ENVIRONMENT") or define("ENVIRONMENT", getenv('ENVIRONMENT')); // Edit the htaccess to change the mode for production // Edite o .htaccess para alterar o modo para produзгo
...
// Array com os arquivos que vгo ser carregados mesmo sem serem definidos no controller
