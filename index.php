...
if(!ENVIRONMENT) // prod
{
	...
	defined("SITE_URL") or define("SITE_URL", strtolower(preg_replace('/[^a-zA-Z]/','',$_SERVER['SERVER_PROTOCOL']))."://".$_SERVER['HTTP_HOST'].preg_replace("/index\.php(.*)/","",$_SERVER['PHP_SELF']));
}
elseif(ENVIRONMENT=="dev") // dev
{
	defined("SITE_PATH") or define("SITE_PATH", dirname(__FILE__)."/");
